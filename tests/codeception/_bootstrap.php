...
// Register module alias so fixtures and model classes can be resolved
$sessionsModulePath = dirname($testRoot);
Yii::setAlias('@sessions', $sessionsModulePath);
Yii::setAlias('@humhub/modules/sessions', $sessionsModulePath);
codecept_debug('Sessions module path: ' . $sessionsModulePath);
